...
CollisionInfo CollisionResponce(double3x3 Ia, double3x3 Ib, double e, double3 ra, double3 rb, double ma, double mb,
                                double3 vai, double3 vbi, double3 wai, double3 wbi, double3 normal)
{
...
Composition GetCollisionComposition(InstanceDescription description1, InstanceDescription description2)
{
	...
	if (description1.instance.mass == 0 && description2.instance.mass == 0)
		return composition;
	if (description1.instance.mass == 0)
		return description2.composition;
	if (description2.instance.mass == 0)
