...
struct CD3DX12_CPU_DESCRIPTOR_HANDLE : public D3D12_CPU_DESCRIPTOR_HANDLE
{
	...
	{
		ptr = static_cast<SIZE_T>(static_cast<INT64>(ptr) + static_cast<INT64>(offsetInDescriptors) * static_cast<INT64>
		(
	...
	static void InitOffsetted(_Out_ D3D12_CPU_DESCRIPTOR_HANDLE& handle,
	                          ...
	                          UINT descriptorIncrementSize)
	{
		handle.ptr = static_cast<SIZE_T>(static_cast<INT64>(base.ptr) + static_cast<INT64>(offsetInDescriptors) *
			static_cast<INT64>(
				descriptorIncrementSize));
	}
};
...
struct CD3DX12_GPU_DESCRIPTOR_HANDLE : public D3D12_GPU_DESCRIPTOR_HANDLE
{
	...
	{
		ptr = static_cast<UINT64>(static_cast<INT64>(ptr) + static_cast<INT64>(offsetInDescriptors) * static_cast<INT64>
		(
			descriptorIncrementSize));
		return *this;
	}
	...
	static void InitOffsetted(_Out_ D3D12_GPU_DESCRIPTOR_HANDLE& handle,
	                          ...
	                          UINT descriptorIncrementSize)
	{
		handle.ptr = static_cast<UINT64>(static_cast<INT64>(base.ptr) + static_cast<INT64>(offsetInDescriptors) *
			static_cast<INT64>(
				descriptorIncrementSize));
	}
};
...
void D3D12DecomposeSubresource(UINT Subresource, UINT MipLevels, UINT ArraySize, _Out_ T& MipSlice,
	...
	UINT NumSlices)
{
	for (UINT z = 0; z < NumSlices; ++z)
	{
		...
		auto pSrcSlice = reinterpret_cast<const BYTE*>(pSrc->pData) + pSrc->SlicePitch * static_cast<LONG_PTR>(z);
...
ID3D12CommandList* const * CommandListCast(t_CommandListType* const * pp)
{
...
public:
	...
	D3D12_STATE_SUBOBJECT_TYPE Type() const override
	{
...
private:
	...
	void* Data() override { return &m_Desc; }
...
private:
	...
	void* Data() override { return m_pRootSig.GetAddressOf(); }
