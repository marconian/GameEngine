...
public:
	...
	void InitProjMatrix(float angle, float client_width, float client_height, float nearest,
	                    float farthest);

	// Initialize camera's orthogonal projection 
	void InitOrthoMatrix(float client_width, float client_height, float near_plane,
	                     float far_plane);
