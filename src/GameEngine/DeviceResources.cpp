...
DeviceResources::~DeviceResources()
{
	...
	// Disable fullscreen mode before destroying resources.
...
void DeviceResources::CreateDeviceResources()
{
	...
	ThrowIfFailed(m_d3dDevice->CreateDescriptorHeap(&rtvDescriptorHeapDescMsaa,
	                                                IID_PPV_ARGS(
		                                                m_msaaRTVDescriptorHeap.ReleaseAndGetAddressOf())));
	...
	ThrowIfFailed(m_d3dDevice->CreateDescriptorHeap(&dsvDescriptorHeapDescMsaa,
	                                                IID_PPV_ARGS(
		                                                m_msaaDSVDescriptorHeap.ReleaseAndGetAddressOf())));
